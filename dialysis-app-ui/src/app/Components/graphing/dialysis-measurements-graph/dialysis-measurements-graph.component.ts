...
export class DialysisMeasurementsGraphComponent implements OnInit, OnDestroy {
    dateRange: Date[] = [];
    chartData: ChartData<'line'> | undefined;
    chartOptions: ChartOptions<'line'> | undefined;
    private subscriptions = new Subscription();

    constructor(private graphingService: GraphingService, private providerService: ProviderService) {}
